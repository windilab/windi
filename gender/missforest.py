...
# データ読み込み
d=pd.read_csv(r"C:\Users\piinb\Documents\DR\WIND\gendergap\female_over_male.csv", encoding='utf-8')
...
df=df.drop('地', axis=1)
df.to_csv(r'\Users\piinb\PycharmProjects\prac\genderraw.csv', encoding='Shift-JIS')
print(df)
...
x1=np.loadtxt(r"C:\Users\piinb\PycharmProjects\prac\gendermiss.txt", delimiter=',')
x1_df=pd.DataFrame(x1)
print(x1_df)
df_miss=pd.concat([yearloc, x1_df], axis=1)
df_miss.columns=df.columns
df_miss.to_csv(r'\Users\piinb\PycharmProjects\prac\gendermissingforest.csv', encoding='Shift-JIS')
print(df_miss)
